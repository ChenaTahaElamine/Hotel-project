...
import AddImageChambreFileConnection from '../../../../../../../FicherDeConnection/FicherChambre/AddImageChambre';
...
const AddImageChambre = () => {
    ...
    const chambre = objChambreTable.getChambreImage();
            ...
            for (const imageUrl of imageUrlsToFetch) {
                try {
                    const response = await axios.get(`${ReturnLeNomDeDominDeApi}/api/admin/image-or-vidio/showFileName/${imageUrl}`, {
                        responseType: 'blob',
                        headers: {
                            'Authorization': `Bearer ${objChambreTable.getToken()}`,
                        },
                    });
    ...
    const onSubmit = async (data) => {
        if (data.image[0]) {
            ...
            try {
                const response = await axios.post(`${ReturnLeNomDeDominDeApi}/api/admin/image-or-vidio/store-img-chambre/${chambre.id}`, formData, {
                    headers: {
                ...
                navigate("/images_or_vidios/ChambreMedia");
    ...
    const onDelete = async (fileName) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                await objChambreTable.deleteImage(fileName);
    ...
    return (
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div className="page-wrapper">
                ...
                <PageBreadcrumb location={"Les images des chambres"} buttonReteur={"/images_or_vidios/ChambreMedia"} />
