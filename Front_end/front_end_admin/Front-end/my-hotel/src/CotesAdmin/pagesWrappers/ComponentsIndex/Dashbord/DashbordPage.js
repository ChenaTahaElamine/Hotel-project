...
function DashbordPage(props) {
    ...
    const recupData = async () => {
        await objAuthUser.indexClients();
    }
    ...
    return (
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div className="page-wrapper">
                ...
                <PageBreadcrumb location={"Dashbord"} />
                    ...
                    <div className='row'>
                        <div className="col-lg-4 col-xlg-3">
                            ...
                            <div className="card">
                                ...
                                <div className="card-body little-profile text-center">
                                    ...
                                    <h3 className="mb-0">{`${objAuthUser.getUser()["nom"]} ${objAuthUser.getUser()["prenom"]}`}</h3>
                                    ...
                                    <div className="row text-center mt-3">
                                        ...
                                        <div className="col-lg-4 col-md-4 mt-3">
                                            <h3 className="mb-0 font-light">23,469</h3><small>Resteraunt</small>
                                        </div>
                                        <div className="col-lg-4 col-md-4 mt-3">
                                            <h3 className="mb-0 font-light">6035</h3><small>chambres</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="message-box contact-box">
                                        ...
                                        <div className="message-widget contact-widget" style={{
                                            "max-height": " 342px",
                                            "overflow-y": "auto"
                                        }}>
                        ...
                        <div className="col-lg-4 col-xlg-3">
                            <div className="card card-body w-100">
                                ...
                                <div className="message-box position-relative mt-3">
                                    <div className="message-widget contact-widget position-relative" style={{
                                        "max-height": " 342px",
                                        "overflow-y": "auto"
                                    }}>
                                        ...
                                        <Link to="/" className=" py-3
                                            ...
                                            <div
                                                className="user-img position-relative d-inline-block me-2"
                                            >
                                                <span
                                                    className="round
                                                    text-white
