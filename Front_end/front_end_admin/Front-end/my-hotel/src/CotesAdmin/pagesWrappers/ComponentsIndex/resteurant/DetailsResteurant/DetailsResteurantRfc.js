    ...
    return (
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div className="page-wrapper">
                ...
                <PageBreadcrumb location={"Details resteurant"} />
                <div className='container-fluid'>
                    <div className='row'>
                        <div className="card">
                            <div className="card-body">
                                <h3 className="card-title">Le nom</h3>
                                <h6 className="card-subtitle">{resteurant.nom}</h6>
                                <div className="row">
...
export default DetailsResteurantRfc;
